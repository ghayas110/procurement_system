...
import ReallocationApproverDetails from "../components/approvers/Reallocationapproverdetails"
import SideBar from "../components/sidebar/Sidebar"


const ApproverDetailsReallocation = ()=>{
            ...
            <div className="row">
                <div className="col-md-12  py-3">
                    ...
                    <i className="fa fa-times" style={{position:"relative",left:"-10px"}} onClick={()=>Close()} id={timesId==false?"timesdeactive":"timesactive"} />
                        REALLOCATION APPROVER SCREEN</h3>
...
export default ApproverDetailsReallocation