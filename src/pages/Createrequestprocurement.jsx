...
import ProcurementCreateRequest from "../components/Createrequests.jsx/Procurementcreaterequest"
import SideBar from "../components/sidebar/Sidebar"


const CreateRequestProcurement = ()=>{
        ...
        <div className="container-fluid d-lg-block d-md-none d-none" style={{backgroundColor:"#eeeeee"}}>
            <div className="row">
                <div className="col-md-12  py-3">
                    ...
                    PROCUREMENT REQUEST SUBMISSION</h3>
...
export default CreateRequestProcurement