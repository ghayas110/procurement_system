...
import ReallocationCreateRequest from "../components/Createrequests.jsx/Reallocationcreaterequest"
import SideBar from "../components/sidebar/Sidebar"


const CreateRequestReallocation = ()=>{
        ...
        <div className="container-fluid d-lg-block d-md-none d-none" style={{backgroundColor:"#eeeeee"}}>
            <div className="row">
                <div className="col-md-12  py-3">
                    ...
                    REALLOCATION REQUEST SUBMISSION</h3>
...
export default CreateRequestReallocation