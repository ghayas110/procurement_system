...
const ReallocationCreateRequest = (props) => {
   ...
   <div className="container-fluid my-4">
      <div className="row">
        <div className="col-md-10 text-center py-5">
            <h1>BUDGET REALLOCATION INFORMATION</h1>
        </div>
      ...
      <table className="table table-bordered border-dark table-responsive rounded">
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" className="form-control" name="" id="" /></td>
            <td><input type="text" className="form-control" name="" id="" /></td>
            <th ><input type="text" className="form-control" name="" id="" /></th>
            <td><input type="text" className="form-control" name="" id="" /></td>
            <td><input type="text" className="form-control" name="" id="" /></td>
            <td><input type="text" className="form-control" name="" id="" /></td>
          </tr>
...
export default ReallocationCreateRequest