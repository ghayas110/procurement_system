                ...
                <div className="col-md-12">
                  <div className="border border-dark rounded py-3">
                    <div className="row d-flex justify-content-center align-items-center">
                        <div className="col-md-8"><h3 className="pl-lg-5">REQUEST REALLOCATION</h3></div>
                        <div className="col-md-4 text-center">
                        <Link to="/create-reallocation-request"><input type="submit"  className=" bg-white text-dark border border-dark rounded-0 text-center py-3" value="CREATE NEW" style={{cursor:"pointer"}} /></Link>
                        </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="row py-3">
                <div className="col-md-12">
                  <div className="border border-dark rounded text-center py-3 hover_details  hover_details">
                    <Link to="/reallocation-request-detail" className="text-dark "  >
                    <div className="row">
